    ...
    public class Solution
    {
        public static int Part1()
        {
            ...
            foreach (var line in inputList)
            {
                ...
                var top = Convert.ToInt32(matches.Groups[1].Value);
                var left = Convert.ToInt32(matches.Groups[2].Value);
                var toBottom = Convert.ToInt32(matches.Groups[3].Value);
                var toRight = Convert.ToInt32(matches.Groups[4].Value);
